  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <nav class="navbar navbar-static-top">
              ...
              <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-info">
                  <div class="box-header" style="text-align: center">
                    <i class="fa fa-book"></i>
                    <h3 class="box-title">Notice Box</h3>
                  ...
                  <div class="box-body"> 
                    <table class="table table-striped">
                      ...
                      <tbody id="notices-list" name="notices-list">
                        @foreach ($notices as $notice) 
                        <tr id="notice{{$notice->id}}" class="table-info">
                          <td style="text-align: center">{{$notice->heading}}</td>                     
                          <td style="text-align: center">
                            
                            <a href="{{url('/download/'.$notice->link)}}"><button class="btn btn-success" value="{{$notice->id}}"><i class="  fa fa-download"></i></button></a>
                           
                            <button class="btn btn-danger btn-delete delete-notice" value="{{$notice->id}}"><i class="fa fa-trash"></i> </button>
                          </td>
                        </tr>                   
                        @endforeach
                      </tbody>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <form id="frmNotice" name="frmNotice" class="form-horizontal"  enctype="multipart/form-data" >

                        <div class="form-group error">
                          <label for="inputName" class="col-sm-3 control-label">Heading</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control has-error" id="notice_heading" name="notice_heading" placeholder="Notice Heading">
                          </div>
                        </div>

                        <div class="form-group error">
                          <label for="inputName" class="col-sm-3 control-label">Pdf</label>
                          <div class="col-sm-9">
        ...
        <script src="{{asset('js/ajaxscriptnotice.js')}}"></script>
