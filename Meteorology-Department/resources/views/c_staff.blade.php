...
<head>
    ...
    <link rel="stylesheet" href="client/css/staff.css">
...
<body>
   ...
   <section id="full_banner">
      <div class="banner">
         ...
         <div class="banner_heading text-center">
             <h3>STAFFS OF THIS DEPARTMENT</h3>
         </div>
      </div>
   </section>
   <!--end of banner-->
           ...
           <div class="row">
               <div class="col-sm-12">
                   <div class="common_heading  text-center text-uppercase">
                       <h1>our efficient <span class="red">staffs</span></h1>
                   </div>
               </div>
           </div>
            <div class="row for_margin slick_staff_slider">
              @foreach ($staffs as $staff)
               <div class="col-xs-12 col-sm-6 col-md-3">
                   <div class="notice_image notice_margin min_height1">
                       <img src="/uploads/image/{{$staff->image}}" class="img-responsive" alt="notice">
                       <div class="notice_text">
                           <h4 class="notice_heading">{{$staff->name}}</h4>
                           <p class="designation">{{$staff->des}}</p>
   ...
   <section id="full_footer">
    ...
    <script src="client/js/staff.js"></script>
</body>
</html>