  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
                  ...
                  <div class="box-body"> 
                    <table class="table table-striped">
                      ...
                      <tbody id="students-list" name="students-list">
                        ...
                        <tr id="student{{$student->id}}" class="table-info">
                          <td style="text-align: center">{{$student->id_card}}</td>
                          <td style="text-align: center">{{$student->name}}</td>
                          <td style="text-align: center">{{$student->roll}}</td>
                          <td style="text-align: center">{{$student->email}}</td>
                          <td style="text-align: center">{{$student->session}}</td>                     
                          <td style="text-align: center">
                           
                            <button class="btn btn-danger btn-delete delete-student" value="{{$student->id}}"><i class="fa fa-trash"></i> </button>
                          </td>
                        </tr>                    
                        @endforeach
                      </tbody>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <form id="frmStudent" name="frmStudent" class="form-horizontal" novalidate="">
                        <div class="form-group error">
                          <label for="inputName" class="col-sm-3 control-label">ID</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control has-error" id="id_card" name="id_card" placeholder="ID">
                          </div>
                        </div>
                        ...
                        <div class="form-group error">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control has-error" id="roll" name="roll" placeholder="Roll No.">
                          </div>
                        </div>
                        ...
                        <div class="form-group error">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control has-error" id="session" name="session" placeholder="Session">
                          </div>
                        </div>
        ...
        <script src="{{asset('js/ajaxscriptstudent.js')}}"></script>
