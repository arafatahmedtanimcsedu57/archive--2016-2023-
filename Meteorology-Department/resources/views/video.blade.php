  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
                  ...
                  <div class="box-body"> 
                    <table class="table table-striped">
                      ...
                      <tbody id="videos-list" name="videos-list">
                        ...
                        <tr id="video{{$video->id}}" class="table-info">
                          <td style="text-align: center">{{$video->name}}</td>                     
                          <td style="text-align: center">
                            
                            <a href="{{$video->link}}"><button class="btn btn-success" value="{{$video->id}}"><i class="fa fa-book"></i></button></a>
                            <button class="btn btn-warning btn-detail open_modal" value="{{$video->id}}"><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger btn-delete delete-video" value="{{$video->id}}"><i class="fa fa-trash"></i> </button>
                          </td>
                        </tr>                    
                        @endforeach
                      </tbody>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <form id="frmVideo" name="frmVideo" class="form-horizontal" novalidate="">
        ...
        <script src="{{asset('js/ajaxscriptvideo.js')}}"></script>
