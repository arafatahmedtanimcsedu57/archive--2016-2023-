  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
            ...
            <div class="row">
              <section class="col-lg-6 connectedSortable">
                ...
                <div class="box box-info">
                  <div class="box-header" style="text-align: center">
                    <i class="fa fa-book"></i>
                    <h3 class="box-title">Our Faculty Members</h3>
                  ...
                  <div class="box-body"> 
                    <table class="table table-striped">
                      ...
                      <tbody id="teachers-list" name="teachers-list">
                        ...
                        @if($teacher->type==1)
                        <tr id="teacher{{$teacher->id}}" class="table-info">
                          <td style="text-align: center"><img class="" src="/uploads/image/{{$teacher->image}}" style="height: 100px; width: 100px; border-radius:50% ; border: 4px solid #d9d9d9 "></td>
                          <td style="text-align: center">{{$teacher->name}}</br>{{$teacher->des}}</br>{{$teacher->deg}}</td>                     
                          <td style="text-align: center">
                            <button class="btn btn-danger btn-delete delete-teacher" value="{{$teacher->id}}"><i class="fa fa-trash"></i> </button>
                          </td>
                        </tr>
                        @endif                    
                        @endforeach
              ...
              <section class="col-lg-6 connectedSortable">
                ...
                <div class="box box-info">
                  <div class="box-header" style="text-align: center">
                    <i class="fa fa-book"></i>
                    <h3 class="box-title">Part Time Members</h3>
                    <div class="pull-right box-tools">
                      <button type="button" class="btn btn-info btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                      <button type="button" class="btn btn-info btn-sm" data-widget="remove"><i class="fa fa-times"></i></button>                    
                    </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <form id="frmTeacher" name="frmTeacher" class="form-horizontal" novalidate="">
                        <div class="form-group error">
                          <label for="inputName" class="col-sm-3 control-label">Image</label>
                          <div class="col-sm-9">
                            <input type="file" class="form-control has-error" id="teacher_image" name="image">
                          </div>
                        </div>
                        ...
                        <div class="form-group error">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control has-error" id="teacher_name" name="teacher_name" placeholder="Name">
                          </div>
                        </div>
                        ...
                        <div class="form-group error">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control has-error" id="teacher_des" name="teacher_des" placeholder="Designation">
                          </div>
                        </div>
                        ...
                        <div class="form-group error">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control has-error" id="teacher_deg" name="teacher_deg" placeholder="Degree">
                          </div>
                        </div>
        ...
        <script src="{{asset('js/ajaxscriptfaculty.js')}}"></script>
