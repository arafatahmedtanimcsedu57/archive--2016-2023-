...
<head>
    ...
    <link rel="stylesheet" href="client/css/pdf_books.css">
...
<body>
          ...
          <div class="row">
              <div class="col-sm-12">
                   <div class="common_heading  text-center text-uppercase">
                       <h1>pdf <span class="red">books</span></h1>
                   </div>
              </div>
          </div>
          <div class="row">
              <div class="col-xs-12 col-sm-12">
                  <table class="table table-bordered table-hover text-center table_design table-striped">
                      <tr>
                          ...
                          <th class="table_head">Download Books</th>
                      </tr>
                      @foreach ($books as $book)
                      <tr>
                        <td>{{$book->book_name}}</td>
                        <td>{{$book->author}}</td>
                        <td><a href="{{url('/download/'.$book->link)}}" class="btn btn_design">Download</a></td>
                      </tr>
                      @endforeach
                  </table>
              </div>
   ...
   <section id="full_footer">
    ...
    <script src="client/js/pdf_books.js"></script>
    <script>
        $(function(){
           new WOW().init(); 
        });
