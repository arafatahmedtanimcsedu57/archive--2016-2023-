...
<head>
    ...
    <link rel="stylesheet" href="client/css/paper_submit.css">
...
<body>
      ...
      <div class="row">
        <div class="submit_section">
          <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="message">
              <h3>Submit Assignment/Project/Thesis Paper</h3>
                {!! Form::open(['url' => '/spaper', 'method' => 'post', 'files' => 'true']) !!}
                  <div class="dd">
                    <input type="text" name="name" id="name" class="name" placeholder="Your Name"> 
                  </div>
                           
                  <div class="dd">
                    <input type="text" name="roll" id="roll" class="name" placeholder="Your Roll No."> 
                  </div>

                  <div class="dd">
                    <input type="text" name="paper_id" id="paper_id" class="name" placeholder="Your ID"> 
                  </div>
                  ...
                  <div class="jj">
                    <input type="text" name="session" id="session" class="name" placeholder="Your Session"> 
                  </div>
                            
                  <input type="file" name="filename" id="filename" class="insert">
          ...
          <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="submit_img">
              <img src="client/images/submit2.jpg" class="img-responsive" height="450" alt="submit2">
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="full_footer">
    ...
    <script src="client/js/paper_submit.js"></script>
    <script>
        $(function(){
           new WOW().init(); 
        });
