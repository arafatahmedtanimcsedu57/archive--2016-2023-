...
<head>
    ...
    <link rel="stylesheet" href="client/css/google_scholar.css">
...
<body>
                ...
                <div class="container cnt for_logo">
                 <nav class="navbar navbar-default menu">
                  ...
                  <ul class="nav navbar-nav navbar-right menu_link">
                    ...
                    <li><a href="event.html" target="_blank">EVENT</a></li>
          ...
          <div class="row">
              <div class="col-sm-12">
                   <div class="common_heading  text-center text-uppercase">
                       <h1>study online <span class="red">books</span></h1>
                   </div>
              </div>
          </div>
          <div class="row">
              <div class="col-xs-12 col-sm-12">
                  <table class="table table-bordered table-hover text-center table_design table-striped">
                      <tr>
                          <th class="table_head">Book</th>
                          <th class="table_head">Link</th>
                      </tr>
                      @foreach ($papers as $paper)
                      <tr>
                        <td>{{$paper->paper_name}}</td>
                        <td><a href="{{$paper->link}}" class="btn btn_radius" target="_blank">Read Book</a></td>
                      </tr>
                      @endforeach
                  </table>
              </div>
   ...
   <section id="full_footer">
    ...
    <script src="client/js/google_scholar.js"></script>
    <script>
        $(function(){
           new WOW().init(); 
        });
