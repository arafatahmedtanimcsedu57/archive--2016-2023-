...
<head>
    ...
    <link rel="stylesheet" href="client/css/research.css">
...
<body>
               ...
               <div class="col-xs-12 col-sm-4">
                   <div class="area">
                      <div class="research_icon text-center">
                       ...
                       <h3>Climatology</h3>
                       <p>Global, regional climate modeling, natural role of trace gases, aerosols, and clouds in global climate, impacts of climate changes on air pollutant emissions and air quality, bias introduced by urban heat islands in assessing global warming, use of long-range transport models to investigate source regions, movements, and deposition patterns associated with pathogenic spore clouds, and synoptic climatology of weather events associated with tropical and extra-tropical cyclones.</p>
                   </div>
               </div>
               <div class="col-xs-12 col-sm-4">
                   <div class="area">
                      <div class="research_icon text-center">
                       ...
                       <h3>Climate Change – Atmospheric Dynamics</h3>
                       <p>Theoretical and numerical analysis of global and regional climate change as a result of both natural and anthropogenic factors. This work involves understanding how atmospheric variability affects and interacts with climate, and through simulations and analysis of global climate models.</p>
                   </div>
               </div>
               <div class="col-xs-12 col-sm-4">
                   <div class="area">
                      <div class="research_icon text-center">
                       ...
                       <h3>Regional Wind Modeling</h3>
                       <p>Analysis of local and regional wind patterns typical of northern California using computer models. This involves understanding the roles played by the ocean, and the coastal mountain ranges in generating observed winds.</p>
                   </div>
               </div>
               <div class="col-xs-12 col-sm-4">
                   <div class="area">
                      <div class="research_icon text-center">
                       ...
                       <h3>Weather Systems and Forecasting</h3>
                       <p>Research topics include synoptic, mesoscale, and convective weather systems via numerical modeling, analysis of observations, and theory.</p>
                   </div>
               </div>
               <div class="col-xs-12 col-sm-4">
                   <div class="area">
                      <div class="research_icon text-center">
                       ...
                       <h3>Mesoscale Processes</h3>
                       <p>Emphasis on mesoscale waves dynamics, orographic precipitation and clouds, downslope winds, and drainage flows.</p>
                   </div>
               </div>
               <div class="col-xs-12 col-sm-4">
                   <div class="area">
                      <div class="research_icon text-center">
                       ...
                       <h3>Tropical Meteorology</h3>
                       <p>Observational and modeling studies of hurricane rapid intensification processes; Studies of tropical cyclogenesis and Saharan dust effects in Atlantic region.</p>
                   </div>
               </div>
               <div class="col-xs-12 col-sm-4">
                   <div class="area">
                      <div class="research_icon text-center">
                       ...
                       <h3>Fire Weather and Wildfire Dynamics</h3>
                       <p>Observations and simulations of conditions leading to severe fire weather in California. Field measurement campaigns, including the use of UAVs (Unmanned Aerial Vehicles), are focused on making on-site observations of fire-induced winds, fire front propagation, fire-plume temperature and moisture perturbations, and resulting convection.</p>
                   </div>
               </div>
               <div class="col-xs-12 col-sm-4">
                   <div class="area">
                      <div class="research_icon text-center">
                       ...
                       <h3>Wind Energy Assessment</h3>
                       <p>Observations and analysis of mesoscale wind patterns for the assessment of wind energy potential at specific sites in California and the western US. This research includes the deployment of towers and the departments Doppler SODAR system at remote locations for site-specific wind studies.</p>
                   </div>
               </div>
              </div>
           </div>
   ...
   <section id="full_footer">
    ...
    <script src="client/js/research.js"></script>
    <script>
        $(function(){
           new WOW().init(); 
        });
